...
main = do
  ...
  case winMaybe of
    ...
    Just window -> do
      ...
      withImg "./container2.jpg" $ \ptr imgWidth imgHeight -> do
      ...
      withImg "./container2_specular.jpg" $ \ptr imgWidth imgHeight -> do
        GL.texImage2D GL.Texture2D GL.NoProxy 0 GL.RGB'
          (TextureSize2D imgWidth imgHeight) 0
            (GL.PixelData GL.RGB GL.UnsignedByte ptr)
        GL.generateMipmap' GL.Texture2D
